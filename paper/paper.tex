...
Because  our fiducial post-Newtonian model (TaylorT4) as implemented in \texttt{lalsuite} does not include spin, we employ the \texttt{SEOBNRv4\_ROM} waveform approximation.
%
