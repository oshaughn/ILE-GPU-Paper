...
After this update, likelihood evaluation costs are not the performance- or cost-limiting feature of RIFT-based source
parameter inference.
...
dominated the overall computational cost.   For example, for a typical analysis of a short signal, \editremark{numbers}
...
\end{align}
\editremark{typical numbers in new configuration, using 16kHz, and also the $s,s'$ factors}



\editremark{discussion}
